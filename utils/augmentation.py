...
BASE_DIR = Path(r'C:\Users\user\Desktop\Git\sesac_localDL260810\Data') 
SRC_DIR = BASE_DIR / 'peach_dataset' / 'YoloDataset'
...
def create_folder(src_folder, dst_folder):
    ...
    #디렉토리 있는지 확인, 복사
    # source_dir = r'./Data/peach_dataset/YoloDataset'
